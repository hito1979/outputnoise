...
# ===== Data =====
cv_0edge = np.array([0.204, 0.208, 0.209, 0.210, 0.205, 0.209, 0.209, 0.206])
cv_1edge = np.array([0.190, 0.193, 0.196, 0.195, 0.191, 0.192, 0.190, 0.193,
                     0.195, 0.194, 0.190, 0.193, 0.191, 0.191, 0.190, 0.193])

cv_2edge = np.array([0.185, 0.188, 0.187, 0.186, 0.187, 0.191, 0.189])

cv_3edge = np.array([0.181])   # Single value
...
plt.savefig("fitz edge.pdf", dpi=300)
plt.show()
