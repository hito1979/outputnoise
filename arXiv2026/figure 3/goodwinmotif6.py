...
# ---------------- Parameters ----------------
d_target = 12.59     # fixed decay rate
n_repeat = 10       # repetitions
k = 1.0; K = 100.0; D = 1e-5
...
for i in range(n_repeat):
    cv_w, cv_x1, cv_x2, cv_x3 = run_simulation(k, K, d_target, D=D)
...
# ---------------- Save CSV ----------------
csv_filename = f"goodwin_K_{d_target:.2f}motif6.csv"
